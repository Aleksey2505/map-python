...
![Выбор файлов и параметров](principe_work.gif)
*Шаг 1: Выбираем видео, SRT файл субтитров, настраиваем точность модели*
*Шаг 2: Нажимаем "Извлечь кадры" и наблюдаем за процессом обработки*
